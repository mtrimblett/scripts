...
echo ""
read -p "Do you want to setup a local ChatGPT client ? " -n 1 -r
if [[ $REPLY =~ ^[Yy]$ ]]
then
  git clone https://github.com/oobabooga/text-generation-webui.git
  #cd text-generation-webui/
  #./start_linux.sh
  echo "Completed cloning oobabooga (local ChatGPT), to run go into the directory 'text-generation-webui' and run './start_lunux.sh' " 
  echo "Download a White Hat Hacker model here (you'll need to create a free account): https://huggingface.co/WhiteRabbitNeo/WhiteRabbitNeo-33B-v1.5/"
  echo "For more information, see: https://www.youtube.com/watch?v=sAjlJlNarc4 & https://www.youtube.com/watch?v=VPW6mVTTtTc "
fi
